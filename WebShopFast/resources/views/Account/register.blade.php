                  ...
                  <div class="col-lg-6">
                    <div class="card-body p-md-5 mx-md-4">
                      ...
                      <div class="text-center">
                        ...
                        <h4 class="mt-1 mb-5 pb-1">REGISTRATION FORM</h4>
                      </div>
                      ...
                      <form action="/register" method="POST" >
                        ...
                        <div class="form-outline mb-4">
                          <input type="date" id="form2Example11" class="form-control" name="Birthday" required
                            placeholder="Birthday" />
                        </div>

                        <div class="form-outline mb-4">
                          <input type="text" id="form2Example11" class="form-control" name="Address" required
                            placeholder="Address" />
                        </div>

                        <div class="form-outline mb-4">
                          <input type="text" id="form2Example11" class="form-control" name="Phone" required
                            placeholder="Phone" />
                        </div>
                        ...
                        <div class="form-outline mb-4">
                          <select class="form-select mb-3" aria-label=".form-select-lg example" name="roleid" required>
                            <option selected value="2">Người mua</option>
