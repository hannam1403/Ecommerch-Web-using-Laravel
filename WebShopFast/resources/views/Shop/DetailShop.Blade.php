                ...
                <div class="row" style="height: 100%"> 
                    ...
                    <div class="col-4" style="width: fit-content;">
                        ...
                        <img src="{{ $user->ava_img_path == null ? asset('images/AvatarImage/defaultAvatarProfile.jpg') : asset('images/AvatarImage/'.$user->ava_img_path) }}" class="rounded-circle" 
                                ...
                                alt="Avatar" />
                        <h5 class="mb-2" style="text-align: center;"><strong>{{$user->name}}</strong></h5>
                        <p class="text-muted" style="text-align: center;">Số dư ví: <span id="AmountVNP"> {{$user->AccountBalance}}</span> </p>
...
<div class="modal fade" id="VnpayPaymentModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <form action="/VnpayPaymentShop" method="post" style="padding: 0">
            @csrf
...
<div class="modal fade" id="Withdraw" aria-hidden="true" aria-labelledby="exampleModalToggleLabel1" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <form action="/DetailShop/withdraw" method="post" style="padding: 0">
            @csrf
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="null1" class="form-label">Số tài khoản VNPay: </label>
                    <input type="text" class="form-control" id="null1" name="null1">
                </div>
                <div class="mb-3">
