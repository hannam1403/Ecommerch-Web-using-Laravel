...
<div class="col py-3 main-panel">
    <section>
      <form class="form-inline d-flex mb-2" action="/DetailDoneOrders" method="GET">
        ...
        <div class="row">  
          <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <a class="link-secondary" href="/DetailDoneOrders" style="text-decoration: none">                
                ...
                <ul class="nav nav-tabs" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" id="deliveryordersuccess-tab"  href="#deliveryordersuccess" data-bs-toggle="tab" role="tab" aria-controls="deliveryordersuccess" aria-selected="false">   
                      Đã giao
                    </a>
                  </li>
                  <li class="nav-item">
                  ...
                  <div class="table-responsive tab-pane fade show active" id="deliveryordersuccess" role="tabpanel" aria-labelledby="deliveryordersuccess-tab">
                    <table class="table table-hover text-center">
                      ...
                      <tbody> 
                        @foreach($deliveryOrdersSuccess as $data) 
                    ...
                    <div class="pagination justify-content-center">
                      {{ $deliveryOrdersSuccess->withQueryString()->links('pagination::bootstrap-4' , ['showInfo' => false]) }}
                    </div>
                  </div>
                </div>
              </div>
