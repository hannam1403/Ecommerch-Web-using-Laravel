...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 01, 2023 lúc 07:38 AM
...
(164, 7, 1, '2023-06-30 22:23:06', 500000, 'Ngọc Lâm');
...
(345, 162, 1, 'Áo phông Xanh cây', 200000, 1, 20, 2, NULL, NULL),
(346, 163, NULL, 'iPhone 14 Pro Max', 25000000, 1, 81, 1, NULL, NULL),
(347, 164, 1, 'Áo Phao vàng', 500000, 1, 26, 3, NULL, NULL);
...
(102, 7, '2023-07-01 00:00:00', 1, 5, 1);
...
--
-- Cấu trúc bảng cho bảng `marketingproduct`
--
...
--
-- Đang đổ dữ liệu cho bảng `marketingproduct`
--
...
(7, 'Ngọc Linh', 'Female', '2023-05-06', '909001238012', 'ngoclinh123', '123', 'imageAva-7-ngoclinh123.jpg', 2, 200000, '2023-03-15 11:56:17', 0, NULL),
...
--
-- Cấu trúc bảng cho bảng `moneytransaction`
--
...
--
-- Đang đổ dữ liệu cho bảng `moneytransaction`
--
...
--
-- Cấu trúc bảng cho bảng `reasonabort`
--
...
--
-- Đang đổ dữ liệu cho bảng `reasonabort`
--
...
--
-- Cấu trúc bảng cho bảng `reasonlock`
--
...
--
-- Đang đổ dữ liệu cho bảng `reasonlock`
--
...
--
-- Cấu trúc bảng cho bảng `reportcomment`
--
...
--
-- Đang đổ dữ liệu cho bảng `reportcomment`
--
...
--
-- Đang đổ dữ liệu cho bảng `roleusers`
--
...
--
-- Cấu trúc bảng cho bảng `webincome`
--
...
--
-- Đang đổ dữ liệu cho bảng `webincome`
--
...
--
-- Chỉ mục cho bảng `marketingproduct`
--
...
--
-- Chỉ mục cho bảng `moneytransaction`
--
...
--
-- Chỉ mục cho bảng `reasonabort`
--
ALTER TABLE `reasonabort`
  ADD PRIMARY KEY (`Id`);

--
-- Chỉ mục cho bảng `reasonlock`
--
ALTER TABLE `reasonlock`
  ADD PRIMARY KEY (`Id`);

--
-- Chỉ mục cho bảng `reportcomment`
--
...
--
-- AUTO_INCREMENT cho bảng `carrier`
--
ALTER TABLE `carrier`
...
--
-- AUTO_INCREMENT cho bảng `marketingproduct`
--
ALTER TABLE `marketingproduct`
...
--
-- AUTO_INCREMENT cho bảng `moneytransaction`
--
ALTER TABLE `moneytransaction`
...
--
-- AUTO_INCREMENT cho bảng `reasonabort`
--
ALTER TABLE `reasonabort`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `reasonlock`
--
ALTER TABLE `reasonlock`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `reportcomment`
--
ALTER TABLE `reportcomment`
...
--
-- AUTO_INCREMENT cho bảng `roleusers`
--
ALTER TABLE `roleusers`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT cho bảng `webincome`
--
ALTER TABLE `webincome`
...
--
-- Các ràng buộc cho bảng `marketingproduct`
--
ALTER TABLE `marketingproduct`
...
--
-- Các ràng buộc cho bảng `reportcomment`
--
ALTER TABLE `reportcomment`
...
--
-- Các ràng buộc cho bảng `reportproduct`
--
ALTER TABLE `reportproduct`
...
--
-- Các ràng buộc cho bảng `webincome`
--
ALTER TABLE `webincome`
